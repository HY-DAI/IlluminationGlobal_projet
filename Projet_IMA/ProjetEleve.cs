...
namespace Projet_IMA
{
    static class ProjetEleve
    {
        public static void Go()
        {
            ...
            MyParallelogram wall_left = new MyParallelogram(new V3(0, 0, 0),  new V3(0, scaley, 0), new V3(0, 0, scalez), 0.01f, new MyMaterial(new Texture(Couleur.Cyan), Texture.BumpMap1));
            ...
            */
            ...
            //   MyLight Light = new MyDirectionalLight(new V3(0, 1, 0), Couleur.White, 0.25f);
            MyLight Light1 = new MyDirectionalLight(new V3(-1, 1, -1), Couleur.White, 0.45f);
            //MyLight Light2 = new MyDirectionalLight(new V3(1, 1f, -1), Couleur.Cyan, 0.25f);
            MyLight Light3 = new MyDirectionalLight(new V3(1, 1f, 1), Couleur.Magenta, 0.15f);
            
            MyRectLight RectLight = new MyRectLight(Couleur.Yellow, 0.10f, wall_rand);
            MyConeLight ConeLight = new MyConeLight(new V3(scalex / 2, scaley / 3, scalez / 2), new V3(0, 0, 1), Couleur.White, 0.1f, 0.5f);
